function novoElemento(tagName, className) {
    const elemen = document.createElement(tagName);
...
function Barreira(reversa = false) {
    ...
    //método pra setar uma altura variada
...
function ParDeBarreiras(altura, abertura, positionX) {
    ...
    // função para pegar a posição de x
...
function Passaro(alturaJogo) {
    ...
    this.animar = () => {
        ...
        //fazer com que ele não colida com o teto e chão
        if (novoY <= 0) {
            this.setY(0)
